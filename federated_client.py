...
class FederatedClient:
    ...
    def __init__(self, config: ClientConfig, data: List[str]):
        self.config = config
    ...
    def train_batch(
        ...
        server_response = self.grpc_client.process_hidden_states(
        ...
        if server_response is not None:
            ...
            logger.warning("Server response failed, using dummy loss")
    ...
    def sync_with_server(self, round_number: int) -> bool:
        ...
        global_state = self.grpc_client.get_global_model(round_number)
    ...
    def send_update_to_server(self, training_results: Dict) -> bool:
        ...
        success = self.grpc_client.send_update(
